...
var AirPlane = function(){
  ...
  var geomCabin = new THREE.CylinderGeometry(40,40,20,5,10);
  ...
  var geomEngine = new THREE.BoxGeometry(20,30,50,1,1,1);
  var matEngine = new THREE.MeshPhongMaterial({color:Colors.black, shading:THREE.FlatShading});
  ...
  var matPropeller = new THREE.MeshPhongMaterial({color:Colors.silver, shading:THREE.FlatShading});
  ...
  var wheelAxisMat = new THREE.MeshPhongMaterial({color:Colors.black, shading:THREE.FlatShading});
